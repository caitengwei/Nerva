...
def _preprocess_model_py() -> str:
    return (
        ...
        "            image_b64 = image_bytes_in.as_numpy().reshape(-1)[0]\n"
        ...
        "            image_b64_bytes = image_b64 if isinstance(image_b64, bytes) else str(image_b64).encode()\n"
        "            try:\n"
        "                image_size = len(base64.b64decode(image_b64_bytes))\n"
        "            except Exception:\n"
        "                image_size = len(image_b64_bytes)\n"
